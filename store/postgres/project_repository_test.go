...
func TestProjectRepository(t *testing.T) {
	...
	t.Run("GetByName", func(t *testing.T) {
		...
		err = NewSecretRepository(db, testModels[0], models.NamespaceSpec{}, hash).Register(ctx, models.ProjectSecretItem{
			Name:  "t1",
			Value: "v1",
		})
		assert.Nil(t, err)
	...
	t.Run("GetAll", func(t *testing.T) {
		...
		err := NewSecretRepository(db, testModels[2], models.NamespaceSpec{}, hash).Register(ctx, models.ProjectSecretItem{
			Name:  "t1",
			Value: "v1",
		})
		assert.Nil(t, err)
		err = NewSecretRepository(db, testModels[3], models.NamespaceSpec{}, hash).Register(ctx, models.ProjectSecretItem{
			Name:  "t2",
			Value: "v2",
		})
		assert.Nil(t, err)
