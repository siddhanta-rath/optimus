...
func generateResourceDestination(jobSpec models.JobSpec) (*models.GenerateDestinationResponse, error) {
	return jobSpec.Task.Unit.DependencyMod.GenerateDestination(context.TODO(), models.GenerateDestinationRequest{
...
func (srv Service) BackupResourceDryRun(ctx context.Context, backupRequest models.BackupRequest, jobSpecs []models.JobSpec) ([]string, error) {
	...
	for _, jobSpec := range jobSpecs {
		destination, err := generateResourceDestination(jobSpec)
		if err != nil {
			return nil, err
		}
