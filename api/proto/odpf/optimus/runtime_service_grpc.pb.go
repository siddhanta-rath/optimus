...
type RuntimeServiceClient interface {
	...
	// UpdateSecret updates existing secret of a project
...
func (c *runtimeServiceClient) UpdateSecret(ctx context.Context, in *UpdateSecretRequest, opts ...grpc.CallOption) (*UpdateSecretResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/odpf.optimus.RuntimeService/UpdateSecret", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *runtimeServiceClient) ListReplays(ctx context.Context, in *ListReplaysRequest, opts ...grpc.CallOption) (*ListReplaysResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/odpf.optimus.RuntimeService/ListReplays", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *runtimeServiceClient) Backup(ctx context.Context, in *BackupRequest, opts ...grpc.CallOption) (*BackupResponse, error) {
	out := new(BackupResponse)
	err := c.cc.Invoke(ctx, "/odpf.optimus.RuntimeService/Backup", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _RuntimeService_UpdateSecret_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/odpf.optimus.RuntimeService/UpdateSecret",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _RuntimeService_ListReplays_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/odpf.optimus.RuntimeService/ListReplays",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _RuntimeService_Backup_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BackupRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RuntimeServiceServer).Backup(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/odpf.optimus.RuntimeService/Backup",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RuntimeServiceServer).Backup(ctx, req.(*BackupRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _RuntimeService_RunJob_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/odpf.optimus.RuntimeService/RunJob",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
